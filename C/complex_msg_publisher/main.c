...
int main(int argc, char * argv[])
{
  ...
  rclc_publisher_t * publisher =
    rclc_create_publisher(node, RCLC_GET_MSG_TYPE_SUPPORT(complex_msgs, msg,
      NestedMsgTest), "complex_msgs_msg_NestedMsgTest",
      1);
  if (publisher == NULL) {
    return -1;
  }
  ...
  while (rclc_ok()) {
    ...
    msg.data14.data1.size = snprintf(msg.data14.data1.data, msg.data14.data1.capacity, "Msg A - %i",
        num);
    msg.data14.data2.size = snprintf(msg.data14.data2.data, msg.data14.data2.capacity, "Msg B - %i",
        num);
    msg.data14.data3.size = snprintf(msg.data14.data3.data, msg.data14.data3.capacity, "Msg C - %i",
        num);
    msg.data14.data4.size = snprintf(msg.data14.data4.data, msg.data14.data4.capacity, "Msg D - %i",
        num);
    num++;
